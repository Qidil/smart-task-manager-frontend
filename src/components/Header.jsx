    ...
    <div className="flex flex-wrap items-center justify-center gap-2 w-full max-w-5xl mx-auto mb-6 px-2">
      ...
      <div className="relative">
        <Listbox value={filterStatus} onChange={(value) => {
          ...
          if (value === "sortByDeadline") {
            setSortBy("deadline");
          } else {
            setSortBy("");
          }
        }}>
          <Listbox.Button className="text-left text-sm bg-indigo-500 rounded text-white w-[100px] px-2 py-2.5 hover:bg-indigo-600 focus:outline-none appearance-none">
          ...
          <img
            ...
            alt="search"
            className="w-3 h-5 absolute right-2 top-1/2 transform -translate-y-1/2 pointer-events-none"
          />
        </Listbox>
      </div>
